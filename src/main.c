...
/*   Updated: 2023/11/30 17:38:55 by mmirzaie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void render(t_rt *rt)
{
    const t_vec3d min = init_vec3d(0,0,0);
    const t_vec3d max = init_vec3d(255.0f, 255.0f, 255.0f);
    ...
    if (rt->hitable)
    {
        for (uint32_t y = 0; y < SIZE; y++)
        {
            for (uint32_t x = 0; x < SIZE; x++)
            {
                ...
                colour = clamp(accum_colour, min, max);
